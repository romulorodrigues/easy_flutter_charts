              ...
              child: SizedBox(
                ...
                child: BarChart(
                  ...
                  data: [
                    ...
                    BarChartData(
                        label: 'Camarões', value: 30, color: Colors.green),
                    BarChartData(
                        label: 'Dinamarca', value: 70, color: Colors.orange),
                    BarChartData(
                        label: ['Estados', 'Unidos', 'da América'],
                        value: 100,
                        color: Colors.orange),
                    BarChartData(
                        label: 'China', value: 25.5, color: Colors.green),
                  ],
                  // onBarTap: (bar) {
              ...
              child: SizedBox(
                ...
                child: BarChart(
                  ...
                  data: [
                    ...
                    BarChartData(
                        label: 'Mai', value: 100, color: Colors.orange),
                    BarChartData(
                        label: 'Jun', value: 25.5, color: Colors.green),
                    BarChartData(
                        label: 'Jul', value: 35.5, color: Colors.green),
                    BarChartData(
                        label: 'Ago', value: 65.5, color: Colors.green),
                    BarChartData(
                        label: 'Set', value: 95.5, color: Colors.green),
                    BarChartData(
                        label: 'Out', value: 28.5, color: Colors.green),
                    BarChartData(
                        label: 'Nov', value: 125.5, color: Colors.green),
                    BarChartData(label: 'Dez', value: 3.5, color: Colors.green),
                  ],
                  // onBarTap: (bar) {
                  //   print('Barra clicada: ${bar.label}, valor: ${bar.value}');
                  // },
                  // barTooltipBuilder: (bar) => '${bar.label}: ${bar.value}',
                ),
              ),
            ),
          ],
